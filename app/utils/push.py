...
class Push(object):
    ...
    def _push_email(self):
        ...
        title = "[{}] CASM消息推送".format(self.task_name[:50])
...
def dingding_send(msg, access_token, secret, msgtype="text", title="CASM消息推送"):
...
def feishu_send(msg, webhook_url, secret, title="CASM消息推送"):
