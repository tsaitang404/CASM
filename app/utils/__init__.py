...
from .casm import domain, get_asset_domain_by_id
...
from .casmupdate import casm_update
...
def init_logger():
    ...
    logger = colorlog.getLogger('casmv2')
...
def get_logger():
    ...
    logger = logging.getLogger('casmv2')
    if not logger.handlers:
        init_logger()

    return logging.getLogger('casmv2')
