...
@ns.route('/export/')
class CASMIPExport(CASMResource):
    parser = get_casm_parser(base_search_fields, location='args')
...
class CASMIPExportDomain(CASMResource):
    parser = get_casm_parser(base_search_fields, location='args')
...
@ns.route('/export_ip/')
class CASMIPExportIp(CASMResource):
    parser = get_casm_parser(base_search_fields, location='args')
...
@ns.route('/delete/')
class DeleteCASMIP(CASMResource):
    @auth
