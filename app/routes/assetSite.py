...
@ns.route('/')
class CASMAssetSite(CASMResource):
...
@ns.route('/export/')
class CASMSiteExport(CASMResource):
    parser = get_casm_parser(base_search_fields, location='args')
...
@ns.route('/delete/')
class DeleteCASMAssetSite(CASMResource):
    @auth
...
class CASMSaveResultSet(CASMResource):
    parser = get_csam_parser(site_search_fields, location='args')
...
@ns.route('/add_tag/')
class AddAssetSiteTagCASM(CASMResource):
...
@ns.route('/delete_tag/')
class DeleteAssetSiteTagCASM(CASMResource):
