...
@ns.route('/')
class CASMTaskScheduleResult(CASMResource):
...
@ns.route('/delete/')
class DeleteCASMTaskScheduler(CASMResource):
...
@ns.route('/stop/')
class StopCASMTaskScheduler(CASMResource):
...
@ns.route('/recover/')
class RecoverCASMTaskScheduler(CASMResource):
