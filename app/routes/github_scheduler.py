...
@ns.route('/')
class CASMGithubScheduler(CASMResource):
...
# Github 监控任务删除
@ns.route('/delete/')
class DeleteGithubScheduler(CASMResource):
...
# Github 监控任务修改
@ns.route('/update/')
class UpdateGithubScheduler(CASMResource):
...
# Github 监控任务恢复
@ns.route('/recover/')
class RecoverGithubScheduler(CASMResource):
...
# Github 监控任务停止
@ns.route('/stop/')
class StopGithubScheduler(CASMResource):
