...
@ns.route('/')
class GithubScheduler(Resource):
...
# Github 监控任务删除
@ns.route('/delete/')
class DeleteGithubScheduler(Resource):
...
# Github 监控任务修改
@ns.route('/update/')
class UpdateGithubScheduler(Resource):
...
# Github 监控任务恢复
@ns.route('/recover/')
class RecoverGithubScheduler(Resource):
...
# Github 监控任务停止
@ns.route('/stop/')
class StopGithubScheduler(Resource):
