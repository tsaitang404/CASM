...
@ns.route('/site/')
class BatchExportSite(CASMResource):
...
@ns.route('/domain/')
class BatchExportDomain(CASMResource):
...
@ns.route('/ip/')
class BatchExportIP(CASMResource):
...
@ns.route('/url/')
class BatchExportURL(CASMResource):
...
@ns.route('/ip_port/')
class BatchExportIpPort(CASMResource):
...
@ns.route('/cip/')
class BatchExportCIP(CASMResource):
...
@ns.route('/wih/')
class BatchExportWIH(CASMResource):
...
@ns.route('/asset_ip/')
class BatchExportAssetIP(CASMResource):
...
@ns.route('/asset_wih/')
class BatchExportAssetWIH(CASMResource):
