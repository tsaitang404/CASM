...
@ns.route('/site/')
class BatchExportSite(Resource):
...
@ns.route('/domain/')
class BatchExportDomain(Resource):
...
@ns.route('/ip_port/')
class BatchExportIpPort(Resource):
...
@ns.route('/asset_ip/')
class BatchExportAssetIP(Resource):
...
@ns.route('/asset_wih/')
class BatchExportAssetWIH(Resource):
