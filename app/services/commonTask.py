...
class CommonTask(object):
    ...
    def insert_task_stat(self):
        ...
        stat = utils.casm.task_statistic(self.task_id)
    ...
    def insert_finger_stat(self):
        finger_stat_map = utils.casm.gen_stat_finger_map(self.task_id)
    ...
    def insert_cip_stat(self):
        cip_map = utils.casm.gen_cip_map(self.task_id)
...
class WebSiteFetch(object):
    ...
    def task_domain_set(self):
        if self._task_domain_set is None:
            self._task_domain_set = set(utils.casm.get_domain_by_id(self.task_id))
